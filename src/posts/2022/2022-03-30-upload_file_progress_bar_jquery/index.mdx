...
Di postingan kali ini kita akan belajar untuk membuat aplikasi upload file menggunakan PHP. 
Di aplikasi yang akan kita buat, kita bisa mengupload file dengan menglik tombol upload atau dengan drag and drop. 
